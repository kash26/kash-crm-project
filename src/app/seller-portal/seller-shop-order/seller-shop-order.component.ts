...
@Component({
  selector: 'app-seller-shop-order',
  templateUrl: './seller-shop-order.component.html',
  styleUrls: ['./seller-shop-order.component.css']
})
export class SellerShopOrderComponent implements OnInit {
  closeResult = '';
  products: any[] = [];
  orders: IOrder;
